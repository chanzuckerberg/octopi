...
!!! note
    This page is adapted from the [copick documentation](https://copick.github.io/copick/examples/tutorials/chimerax/).
...
1. Open ChimeraX
2. Go to [**Tools > More Tools...**](javascript:void(0); "<img src='https://copick.github.io/copick/assets/chimerax_tutorial/toolshed_install_more_tools.png'>") to open the toolshed
3. Search for `copick` in the search bar
4. Download and install the copick plugin by clicking on **Install**

<figure markdown="span">
  ![Toolshed](https://copick.github.io/copick/assets/chimerax_tutorial/toolshed_full.png){ width="100%" }
...
<figure markdown="span">
  ![Main GUI](https://copick.github.io/copick/assets/chimerax_tutorial/main_gui_overview.png){ width="100%" }
...
**Annotation Panel**
<div markdown>
![Annotation Panel](https://copick.github.io/copick/assets/chimerax_tutorial/main_gui_annotation_panel.png)
</div>
...
**Tomogram Panel**
<div markdown>
![Tomogram Panel](https://copick.github.io/copick/assets/chimerax_tutorial/main_gui_tomogram_panel.png)
</div>
<div markdown>
...
In the Copick Annotation Panel, click the [✏️ Edit Object Types](javascript:void(0); "<img src='https://copick.github.io/copick/assets/chimerax_tutorial/add_object_button.png'>") button (pencil icon) at the top.
...
<figure markdown="span">
  ![Edit Object](https://copick.github.io/copick/assets/chimerax_tutorial/add_object_dialog.png){ width="100%" }
...
1. Click the [📄 Add New](javascript:void(0); "<img src='https://copick.github.io/copick/assets/chimerax_tutorial/add_object_add_new.png'>") button
...
<figure markdown="span">
  ![Edit Object](https://copick.github.io/copick/assets/chimerax_tutorial/add_object_params.png){ width="100%" }
  <figcaption>Edit Objects Dialog form with metadata fields filled in.</figcaption>
</figure>

3. Click the [✅ Save Object](javascript:void(0); "<img src='https://copick.github.io/copick/assets/chimerax_tutorial/add_object_save_object.png'>") button to add the new object type

4. The status will show a success message

5. Click [**Save & Close**](javascript:void(0); "<img src='https://copick.github.io/copick/assets/chimerax_tutorial/add_object_save_close.png'>") to apply changes to your configuration

<figure markdown="span">
  ![Edit Object](https://copick.github.io/copick/assets/chimerax_tutorial/add_object_finish.png){ width="100%" }
...
<figure markdown="span">
  ![Opened Tomogram](https://copick.github.io/copick/assets/chimerax_tutorial/main_gui_view_tomogram.png){ width="100%" }
...
|:----------------------------------------------------------------------------:|:-----------------:|------------------|----------------------------------|
|        ![Slab](https://copick.github.io/copick/assets/chimerax_tutorial/slab.png){ width="30" }        |    ++q+q++    |    Tilted Slab    | Single plane view (default)      |
| ![Orthoplanes](https://copick.github.io/copick/assets/chimerax_tutorial/orthoplanes.png){ width="30" } |    ++e+e++    |    Orthoplanes    | XY, XZ, YZ planes simultaneously |
|    ![Volume](https://copick.github.io/copick/assets/chimerax_tutorial/fullvolume.png){ width="30" }    |    ++e+e++    | Volume Rendering  | Density-based olume rendering    |
|  ![Surface](https://copick.github.io/copick/assets/chimerax_tutorial/view_surface.png){ width="30" }   |    ++e+e++    |    Isosurface     | Threshold and compute isosurface |
|      ![Picks](https://copick.github.io/copick/assets/chimerax_tutorial/view_xy.png){ width="30" }      |    ++x+x++    |      XY View      | View from Z axis                 |
|      ![Picks](https://copick.github.io/copick/assets/chimerax_tutorial/view_yz.png){ width="30" }      |    ++y+y++    |      YZ View      | View from X axis                 |
|      ![Picks](https://copick.github.io/copick/assets/chimerax_tutorial/view_xz.png){ width="30" }      |    ++z+z++    |      XZ View      | View from Y axis                 |

</div>

### Adjusting Contrast

Use the [Contrast](javascript:void(0); "<img src='https://copick.github.io/copick/assets/chimerax_tutorial/tomogram_contrast.png'>") panel (right side) to adjust visualization:
...
2. In the **Picks** tab of the Copick Annotation Panel, click the
   [📄 New](javascript:void(0); "<img src='https://copick.github.io/copick/assets/chimerax_tutorial/pick_new_particle_list.png'>") button
...
<div markdown>
![Create New Pick dialog](https://copick.github.io/copick/assets/chimerax_tutorial/pick_new_picks_dialog.png)
</div>
...
<div class="side-by-side" markdown>
<div markdown>
![Create New Pick dialog](https://copick.github.io/copick/assets/chimerax_tutorial/pick_picks_set_added.png)
</div>
...
<figure markdown="span">
  ![Picked](https://copick.github.io/copick/assets/chimerax_tutorial/pick_actual_picks_added.png){ width="100%" }
...
Use the [Stepper Widget](javascript:void(0); "<img src='https://copick.github.io/copick/assets/chimerax_tutorial/pick_stepper.png'>") below the Picks table:
...
=== "Moving Particles"
    ...
    3. Use toolbar buttons:
        - [Translate Selected Particles](javascript:void(0); "<img src='https://copick.github.io/copick/assets/chimerax_tutorial/translate_selected.png'>")
        - [Rotate Selected Particles](javascript:void(0); "<img src='https://copick.github.io/copick/assets/chimerax_tutorial/rotate_selected.png'>")
