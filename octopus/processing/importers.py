...
import copick, argparse, mrcfile
...
def cli_mrcs():
    ...
    parser.add_argument('--target-tomo-type', type=str, required=True, help='Local name')
    parser.add_argument('--input-voxel-size', type=float, required=True, help='Voxel size')
    parser.add_argument('--output-voxel-size', type=float, required=False, default=None, help='Save voxel size')
    args = parser.parse_args()
    from_mrcs(args.mrcs_path, args.target_tomo_type, args.input_voxel_size, args.output_voxel_size)
